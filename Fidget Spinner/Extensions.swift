...
extension UIView {
	...
	public func addConstraintsWithFormat(_ format: String, options: NSLayoutFormatOptions? = nil, views: [String: UIView]) {
		for (_, view) in views {
			view.translatesAutoresizingMaskIntoConstraints = false
		}
		let myOptions = options ?? NSLayoutFormatOptions()
		addConstraints(NSLayoutConstraint.constraints(withVisualFormat: format, options: myOptions, metrics: nil, views: views))
	}
